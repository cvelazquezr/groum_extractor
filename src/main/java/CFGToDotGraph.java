...
public class CFGToDotGraph {
    protected boolean onePage; // in one or several 8.5x11 pages.
    protected boolean isBrief;
    protected boolean showExceptions;
    protected DotGraphAttribute unexceptionalControlFlowAttr;
    protected DotGraphAttribute exceptionalControlFlowAttr;
    protected DotGraphAttribute exceptionEdgeAttr;
    protected DotGraphAttribute headAttr;
    protected DotGraphAttribute tailAttr;
     ...
     *
     * @see <a href="http://www.research.att.com/sw/tools/graphviz/dotguide.pdf">"Drawing groum.graphs with dot"</a>
     */
     ...
     * for different groum.graphs of a given method.)
     *
     ...
     */
    protected static Iterator sortedIterator(Collection coll, Comparator comp) {
        if (coll.size() <= 1) {
     ...
     */
    protected static class NodeComparator implements java.util.Comparator {
     ...
     */
    protected static class ExceptionDestComparator implements java.util.Comparator {
        private DotNamer namer;
    ...
    public <N> DotGraph drawCFG(ExceptionalGraph<N> graph) {
        ...
        // comparisons between groum.graphs of a given method.
        for (Iterator nodesIt = graph.iterator(); nodesIt.hasNext(); ) {
            String junk = namer.getName(nodesIt.next());
        }
     ...
     */
    protected DotGraph initDotGraph(Body body) {
     ...
     */
    protected void formatNodeText(Body body, DotGraph canvas, DotNamer namer) {
     ...
     */
    protected void setStyle(Collection objects, DotGraph canvas,
     ...
     */
    protected String formatThrowableSet(ThrowableSet set) {
